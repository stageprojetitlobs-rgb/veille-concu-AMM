...
from veille.sources.phase1_regulatory.minepia_cameroun import MinepiaCamerounSource
...
_SOURCES: dict[str, type[Source]] = {
    ...
    MinepiaCamerounSource.name: MinepiaCamerounSource,  # AMM Cameroun — MINEPIA, PDF officiel
